...
module.exports = Base.extend(function Drop(container, options) {
    ...
    dropTennisBall: function() {
        ...
        if (!this.firstTennisBall) {
            console.log('setting first tennis ball:');
            this.firstTennisBall = ball;
            console.log(this.firstTennisBall);
        }
    ...
    setup: function (container) {
        ...
        new LogBook(world, topGate, bottomGate, container, 5, logColumns);
    ...
    demonstrateDrop: function(callback) {
        ...
        ball.state.pos.x = 125;
        ball.state.pos.y = 170;
        ball.recalc()
