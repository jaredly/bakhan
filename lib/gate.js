...
function Gate(world, container, polygon, pos, body, opts) {
    ...
    this.view = this.world.renderer().createView(this.collision_body.geometry, {
        strokeStyle: '#aaa', lineWidth: 2, fillStyle: 'rgba(0,0,0,0)' })
...
Gate.prototype._subscribe = function() {
    ...
    var alpha = 0.5;
    var fillStyle = {
        green: '0x80FF80',// 'rgba(50,100,50,'+alpha+')',
        red: '0xFF8080',// 'rgba(100,50,50,'+alpha+')',
        undefined: '0x000000',// 'rgba(0,0,0,'+alpha+')',
    }
    var polygon = r.createPolygon(this.moved_points, {
        strokeStyle: strokeStyles[this._color],
        lineWidth: 2,
        fillStyle: fillStyle[this._color],
    });
    r.stage.addChild(polygon);
}
